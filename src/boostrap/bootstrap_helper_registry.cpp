...
void RegisterIDRegistry() {
  ...
  Mngr.RegisterType<W>();
  Mngr.AddMethod<MemFuncOf<W, void(T, std::string_view)>::get(
      &W::RegisterUnmanaged)>("RegisterUnmanaged");
  Mngr.AddMethod<MemFuncOf<W, T(std::string_view)>::get(&W::RegisterUnmanaged)>(
      "RegisterUnmanaged");
