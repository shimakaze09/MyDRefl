...
void My::MyDRefl::ext::details::Bootstrap_helper_object() {
  ...
  Mngr->AddMemberMethod("GetTypeFieldVars", [](const ObjectView& obj) {
    return obj.GetTypeFieldVars();
  });
  ...
  Mngr->AddMethod<&ObjectView::AddLValueReferenceWeak>(
      "AddLValueReferenceWeak");
