...
void My::MyDRefl::ext::details::Bootstrap_helper_object() {
  ...
  Mngr.AddMethod<&ObjectView::StaticCast_DerivedToBase>(
      "StaticCast_DerivedToBase");
  Mngr.AddMethod<&ObjectView::StaticCast_BaseToDerived>(
      "StaticCast_BaseToDerived");
  Mngr.AddMethod<&ObjectView::DynamicCast_BaseToDerived>(
  ...
  Mngr.AddMethod<MemFuncOf<ObjectView, ObjectView(Name, FieldFlag) const>::get(
      &ObjectView::Var)>("Var");
  Mngr.AddMethod<MemFuncOf<ObjectView, ObjectView(Type, Name, FieldFlag)
                                           const>::get(&ObjectView::Var)>(
      "Var");
  Mngr.AddMemberMethod("Var", [](const ObjectView& obj, Name field_name) {
    return obj.Var(field_name);
  });
  Mngr.AddMemberMethod("Var",
                       [](const ObjectView& obj, Type base, Name field_name) {
                         return obj.Var(base, field_name);
                       });

  Mngr.AddMethod<&ObjectView::GetVars>("GetVars");
  Mngr.AddMemberMethod("GetVars",
                       [](const ObjectView& obj) { return obj.GetVars(); });
  Mngr.AddMethod<&ObjectView::GetFields>("GetFields");
  Mngr.AddMemberMethod("GetFields",
                       [](const ObjectView& obj) { return obj.GetFields(); });
  Mngr.AddMethod<&ObjectView::GetMethods>("GetMethods");
  Mngr.AddMemberMethod("GetMethods",
                       [](const ObjectView& obj) { return obj.GetMethods(); });
  Mngr.AddMethod<&ObjectView::GetObjectTree>("GetObjectTree");
  Mngr.AddMemberMethod("GetObjectTree", [](const ObjectView& obj) {
    return obj.GetObjectTree();
  });
  ...
  Mngr.AddMethod<&ObjectView::AddConstLValueReference>(
      "AddConstLValueReference");
  Mngr.AddMethod<&ObjectView::AddConstRValueReference>(
