...
void Smkz::MyDRefl::ext::details::Bootstrap_helper_utemplate() {
  // MyTemplate
  ...
  Mngr.AddMemberMethod(NameIDRegistry::Meta::ctor,
                       [](NameID& id, const char* const& str) {
  ...
  Mngr.AddMethod<MemFuncOf<Type, bool(std::string_view) const noexcept>::get(
      &Type::Is)>("Is");
}
