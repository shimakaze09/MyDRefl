...
void My::MyDRefl::ext::details::Bootstrap_helper_reflmngr_0() {
  ...
  Mngr.AddMethod<MemFuncOf<ReflMngr, Type(Type, std::size_t, std::size_t, bool,
                                          bool)>::get(&ReflMngr::RegisterType)>(
      "RegisterType");
  Mngr.AddMemberMethod(
      "RegisterType",
      [](ReflMngr& mngr, Type type, std::size_t size, std::size_t alignment) {
        return mngr.RegisterType(type, size, alignment);
      });
  Mngr.AddMemberMethod(
      "RegisterType", [](ReflMngr& mngr, Type type, std::size_t size,
                         std::size_t alignment, bool is_polymorphic) {
        return mngr.RegisterType(type, size, alignment, is_polymorphic);
      });
  Mngr.AddMethod<
      MemFuncOf<ReflMngr, Type(Type, std::span<const Type>,
                               std::span<const Type>, std::span<const Name>,
                               bool)>::get(&ReflMngr::RegisterType)>(
      "RegisterType");
  Mngr.AddMemberMethod(
      "RegisterType",
      [](ReflMngr& mngr, Type type, std::span<const Type> bases,
         std::span<const Type> field_types, std::span<const Name> field_names) {
        return mngr.RegisterType(type, bases, field_types, field_names);
      });
  ...
  Mngr.AddMethod<&ReflMngr::AddZeroDefaultConstructor>(
      "AddZeroDefaultConstructor");
  ...
  Mngr.AddMethod<&ReflMngr::StaticCast_BaseToDerived>(
      "StaticCast_BaseToDerived");
  Mngr.AddMethod<&ReflMngr::DynamicCast_BaseToDerived>(
  ...
  Mngr.AddMemberMethod("GetTypeFields", [](ReflMngr& mngr, Type type) {
    return mngr.GetTypeFields(type);
  });
  Mngr.AddMethod<&ReflMngr::GetFields>("GetFields");
  Mngr.AddMemberMethod("GetFields", [](ReflMngr& mngr, Type type) {
    return mngr.GetFields(type);
  });
  Mngr.AddMethod<&ReflMngr::GetTypeMethods>("GetTypeMethods");
  Mngr.AddMemberMethod("GetTypeMethods", [](ReflMngr& mngr, Type type) {
    return mngr.GetTypeMethods(type);
  });
  Mngr.AddMethod<&ReflMngr::GetMethods>("GetMethods");
  Mngr.AddMemberMethod("GetMethods", [](ReflMngr& mngr, Type type) {
    return mngr.GetMethods(type);
  });
  Mngr.AddMethod<&ReflMngr::GetTypeFieldVars>("GetTypeFieldVars");
  Mngr.AddMemberMethod("GetTypeFieldVars", [](ReflMngr& mngr, ObjectView obj) {
    return mngr.GetTypeFieldVars(obj);
  });
  Mngr.AddMethod<&ReflMngr::GetVars>("GetVars");
  Mngr.AddMemberMethod("GetVars", [](ReflMngr& mngr, ObjectView obj) {
    return mngr.GetVars(obj);
  });

  Mngr.AddMethod<&ReflMngr::ContainsBase>("ContainsBase");
  Mngr.AddMemberMethod("ContainsBase",
                       [](ReflMngr& mngr, Type type, Type base) {
                         return mngr.ContainsBase(type, base);
                       });
  Mngr.AddMethod<&ReflMngr::ContainsField>("ContainsField");
  Mngr.AddMemberMethod("ContainsField",
                       [](ReflMngr& mngr, Type type, Name name) {
                         return mngr.ContainsField(type, name);
                       });
  Mngr.AddMethod<&ReflMngr::ContainsMethod>("ContainsMethod");
  Mngr.AddMemberMethod("ContainsMethod",
                       [](ReflMngr& mngr, Type type, Name name) {
                         return mngr.ContainsMethod(type, name);
                       });
}
