...
StrIDRegistry::StrIDRegistry() {
  ...
  RegisterUnmanaged(MetaID::operator_assign_lshift,
                    Meta::operator_assign_lshift);
  RegisterUnmanaged(MetaID::operator_assign_rshift,
  ...
  RegisterUnmanaged(MetaID::operator_member_of_pointer,
  ...
  RegisterUnmanaged(MetaID::container_bucket_count,
                    Meta::container_bucket_count);
  RegisterUnmanaged(MetaID::container_reserve, Meta::container_reserve);
  RegisterUnmanaged(MetaID::container_shrink_to_fit,
  ...
  RegisterUnmanaged(MetaID::container_insert_or_assign,
  ...
  RegisterUnmanaged(MetaID::container_hash_function,
                    Meta::container_hash_function);
  RegisterUnmanaged(MetaID::container_key_eq, Meta::container_key_eq);
  RegisterUnmanaged(MetaID::container_get_allocator,
