...
MethodPtr::MethodPtr(MemberVariableFunction* func, Type result_type,
                     ParamList paramList)
    : func{func},
...
MethodPtr::MethodPtr(MemberConstFunction* func, Type result_type,
                     ParamList paramList)
    : func{func},
      result_type{std::move(result_type)},
      paramList{std::move(paramList)} {
...
MethodPtr::MethodPtr(StaticFunction* func, Type result_type,
                     ParamList paramList)
    : func{func},
      result_type{std::move(result_type)},
      paramList{std::move(paramList)} {
...
MethodPtr::MethodPtr(std::function<MemberVariableFunction> func,
                     Type result_type, ParamList paramList)
    : func{(assert(func), std::move(func))},
      result_type{std::move(result_type)},
      paramList{std::move(paramList)} {}

MethodPtr::MethodPtr(std::function<MemberConstFunction> func, Type result_type,
                     ParamList paramList)
    : func{(assert(func), std::move(func))},
      result_type{std::move(result_type)},
      paramList{std::move(paramList)} {}

MethodPtr::MethodPtr(std::function<StaticFunction> func, Type result_type,
                     ParamList paramList)
    : func{(assert(func), std::move(func))},
      result_type{std::move(result_type)},
      paramList{std::move(paramList)} {}
...
void MethodPtr::Invoke(void* obj, void* result_buffer,
