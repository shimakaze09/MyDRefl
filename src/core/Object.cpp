...
Type ObjectView::Invoke(Name method_name, void* result_buffer,
  ...
  return Mngr->Invoke(*this, method_name, result_buffer, argTypes,
                      argptr_buffer, flag);
}
...
ObjectView ObjectView::tuple_get(std::size_t i) const {
  return Mngr->Invoke<ObjectView>(*this, NameIDRegistry::Meta::tuple_get,
                                  std::move(i));
}
