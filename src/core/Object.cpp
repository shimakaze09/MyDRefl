...
InvokeResult ObjectPtr::Invoke(StrID methodID, void* result_buffer,
  ...
  return Mngr->Invoke(*this, methodID, result_buffer, argTypeIDs,
                      argptr_buffer);
}
...
std::vector<std::tuple<TypeRef, FieldRef, ObjectPtr>>
ObjectPtr::GetTypeFieldOwnedVars() {
...
ObjectPtr ObjectPtr::FindOwnedVar(
...
ObjectPtr ObjectPtr::tuple_get(std::size_t i) const {
  return Mngr->Invoke<ObjectPtr>(*this, StrIDRegistry::MetaID::tuple_get,
                                 std::move(i));
}
