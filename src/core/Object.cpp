...
ConstObjectPtr ObjectPtrBase::StaticCast_DerivedToBase(
    TypeID typeID) const noexcept {
  return ReflMngr::Instance().StaticCast_DerivedToBase(ConstObjectPtr{ID, ptr},
                                                       typeID);
}

ConstObjectPtr ObjectPtrBase::StaticCast_BaseToDerived(
    TypeID typeID) const noexcept {
  return ReflMngr::Instance().StaticCast_BaseToDerived(ConstObjectPtr{ID, ptr},
                                                       typeID);
}

ConstObjectPtr ObjectPtrBase::DynamicCast_BaseToDerived(
    TypeID typeID) const noexcept {
  return ReflMngr::Instance().DynamicCast_BaseToDerived(ConstObjectPtr{ID, ptr},
                                                        typeID);
}
...
void ObjectPtr::reserve(std::size_t n) const {
  ReflMngr::Instance().DMInvoke(*this,
                                StrIDRegistry::MetaID::container_reserve);
}

void ObjectPtr::shrink_to_fit() const {
  ReflMngr::Instance().DMInvoke(*this,
                                StrIDRegistry::MetaID::container_shrink_to_fit);
}
...
void ObjectPtr::pop_front() const {
  ReflMngr::Instance().DMInvoke(*this,
                                StrIDRegistry::MetaID::container_pop_front);
}

void ObjectPtr::pop_back() const {
  ReflMngr::Instance().DMInvoke(*this,
                                StrIDRegistry::MetaID::container_pop_back);
}
...
SharedConstObject::SharedConstObject(const SharedObject& obj)
    : SharedConstObject{obj.GetID(), obj.GetBuffer()} {}

SharedConstObject::SharedConstObject(SharedObject&& obj) noexcept
    : SharedConstObject{obj.GetID(), obj.GetBuffer()} {}
