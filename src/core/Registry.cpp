...
NameRegistry::NameRegistry() {
  ...
  registry.Register(string_hash(Meta::operator_assign_add),
                    Meta::operator_assign_add);
  registry.Register(string_hash(Meta::operator_assign_minus),
                    Meta::operator_assign_minus);
  registry.Register(string_hash(Meta::operator_assign_mul),
                    Meta::operator_assign_mul);
  registry.Register(string_hash(Meta::operator_assign_div),
                    Meta::operator_assign_div);
  registry.Register(string_hash(Meta::operator_assign_mod),
                    Meta::operator_assign_mod);
  registry.Register(string_hash(Meta::operator_assign_band),
                    Meta::operator_assign_band);
  registry.Register(string_hash(Meta::operator_assign_bor),
                    Meta::operator_assign_bor);
  registry.Register(string_hash(Meta::operator_assign_bxor),
                    Meta::operator_assign_bxor);
  registry.Register(string_hash(Meta::operator_assign_lshift),
                    Meta::operator_assign_lshift);
  registry.Register(string_hash(Meta::operator_assign_rshift),
                    Meta::operator_assign_rshift);

  registry.Register(string_hash(Meta::operator_new), Meta::operator_new);
  registry.Register(string_hash(Meta::operator_new_array),
                    Meta::operator_new_array);
  registry.Register(string_hash(Meta::operator_delete), Meta::operator_delete);
  registry.Register(string_hash(Meta::operator_delete_array),
                    Meta::operator_delete_array);
