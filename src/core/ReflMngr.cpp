...
std::pmr::vector<TypeID> ReflMngr::GetTypeIDs(TypeID typeID) {
  std::pmr::vector<TypeID> rst{
      std::pmr::polymorphic_allocator<TypeID>{&sync_rsrc}};
...
std::pmr::vector<TypeRef> ReflMngr::GetTypes(TypeID typeID) {
  std::pmr::vector<TypeRef> rst{
      std::pmr::polymorphic_allocator<TypeRef>{&sync_rsrc}};
...
std::pmr::vector<TypeFieldRef> ReflMngr::GetTypeFields(TypeID typeID) {
  std::pmr::vector<TypeFieldRef> rst{
      std::pmr::polymorphic_allocator<TypeFieldRef>{&sync_rsrc}};
...
std::pmr::vector<FieldRef> ReflMngr::GetFields(TypeID typeID) {
  std::pmr::vector<FieldRef> rst{
      std::pmr::polymorphic_allocator<FieldRef>{&sync_rsrc}};
  ForEachField(typeID, [&rst](TypeRef type, FieldRef field) {
    rst.push_back(field);
    return true;
  });
...
std::pmr::vector<TypeMethodRef> ReflMngr::GetTypeMethods(TypeID typeID) {
  std::pmr::vector<TypeMethodRef> rst{
      std::pmr::polymorphic_allocator<TypeMethodRef>{&sync_rsrc}};
...
std::pmr::vector<MethodRef> ReflMngr::GetMethods(TypeID typeID) {
  std::pmr::vector<MethodRef> rst{
      std::pmr::polymorphic_allocator<MethodRef>{&sync_rsrc}};
  ForEachMethod(typeID, [&rst](TypeRef type, MethodRef field) {
    rst.push_back(field);
    return true;
  });
...
ReflMngr::GetTypeFieldRWVars(TypeID typeID) {
  std::pmr::vector<std::tuple<TypeRef, FieldRef, ObjectPtr>> rst{
      std::pmr::polymorphic_allocator<std::tuple<TypeRef, FieldRef, ObjectPtr>>{
          &sync_rsrc}};
...
std::pmr::vector<ObjectPtr> ReflMngr::GetRWVars(TypeID typeID) {
  std::pmr::vector<ObjectPtr> rst{
      std::pmr::polymorphic_allocator<ObjectPtr>{&sync_rsrc}};
  ForEachRWVar(typeID, [&rst](TypeRef type, FieldRef field, ObjectPtr var) {
    rst.push_back(var);
    return true;
  });
...
ReflMngr::GetTypeFieldRVars(TypeID typeID) {
  std::pmr::vector<std::tuple<TypeRef, FieldRef, ConstObjectPtr>> rst{
      std::pmr::polymorphic_allocator<
          std::tuple<TypeRef, FieldRef, ConstObjectPtr>>{&sync_rsrc}};
...
std::pmr::vector<ConstObjectPtr> ReflMngr::GetRVars(TypeID typeID) {
  std::pmr::vector<ConstObjectPtr> rst{
      std::pmr::polymorphic_allocator<ConstObjectPtr>{&sync_rsrc}};
  ForEachRVar(typeID, [&rst](TypeRef type, FieldRef field, ConstObjectPtr var) {
    rst.push_back(var);
    return true;
  });
