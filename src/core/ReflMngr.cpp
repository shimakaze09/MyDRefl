...
ObjectView ReflMngr::StaticCast_DerivedToBase(ObjectView obj, Type type) const {
  ...
  switch (cvref_mode) {
    case CVRefMode::Left:
      return StaticCast_DerivedToBase(obj.RemoveLValueReference(), type)
          .AddLValueReference();
    case CVRefMode::Right:
      return StaticCast_DerivedToBase(obj.RemoveRValueReference(), type)
          .AddRValueReference();
...
ObjectView ReflMngr::StaticCast_BaseToDerived(ObjectView obj, Type type) const {
  ...
  switch (cvref_mode) {
    case CVRefMode::Left:
      return StaticCast_BaseToDerived(obj.RemoveLValueReference(), type)
          .AddLValueReference();
    case CVRefMode::Right:
      return StaticCast_BaseToDerived(obj.RemoveRValueReference(), type)
          .AddRValueReference();
    case CVRefMode::Const:
...
ObjectView ReflMngr::DynamicCast_BaseToDerived(ObjectView obj,
  ...
  switch (cvref_mode) {
    case CVRefMode::Left:
      return DynamicCast_BaseToDerived(obj.RemoveLValueReference(), type)
          .AddLValueReference();
    case CVRefMode::Right:
      return DynamicCast_BaseToDerived(obj.RemoveRValueReference(), type)
          .AddRValueReference();
    case CVRefMode::Const:
...
ObjectView ReflMngr::Var(ObjectView obj, Name field_name, FieldFlag flag) {
  ...
  switch (cvref_mode) {
    case CVRefMode::Left:
      return Var(obj.RemoveLValueReference(), field_name, flag)
          .AddLValueReference();
    case CVRefMode::Right:
      return Var(obj.RemoveRValueReference(), field_name, flag)
          .AddRValueReference();
    case CVRefMode::Const:
  ...
  switch (cvref_mode) {
    ...
    case CVRefMode::ConstRight:
      return IsInvocable(type.RemoveCVRef(), method_name, argTypes,
                         enum_remove(flag, MethodFlag::Variable));
    default:
      break;
  }
