...
int main() {
  ...
  {  // register Point
    ...
    TypeInfo typeinfo{
        ...
        {{ID_data, fieldinfo_data},
         ...
         {ID_sc_data, fieldinfo_sc_data}},  // fields
    };
  ...
  std::cout << ReflMngr::Instance().RField(ptr, ID_c_data).As<int>()
            << std::endl;
  std::cout << ReflMngr::Instance().RField(ptr, ID_s_data).As<int>()
            << std::endl;
  std::cout << ReflMngr::Instance().RField(ptr, ID_sc_data).As<int>()
            << std::endl;
