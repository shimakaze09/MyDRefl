...
class SharedBlock {
 public:
  ...
  SharedBlock(void* ptr, std::function<void(void*)> deleter)
      : ptr{ptr, deleter} {}
  ...
  SharedBlock(std::nullptr_t ptr, Deleter&& d)
...
inline bool operator==(const My::MyDRefl::SharedBlock& left,
                       const My::MyDRefl::SharedBlock& right) noexcept {
...
std::basic_ostream<Elem, Traits>& operator<<(
    ...
    const My::MyDRefl::SharedBlock& obj) {
  return out << obj.Get();
}

namespace std {
inline void swap(My::MyDRefl::SharedBlock& left,
                 My::MyDRefl::SharedBlock& right) noexcept {
  left.Swap(right);
}
