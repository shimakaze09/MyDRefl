...
std::size_t field_forward_offset_value(T Obj::* field_ptr) noexcept {
  ...
  return reinterpret_cast<std::size_t>(
      &(reinterpret_cast<const Obj*>(0)->*field_ptr));
}
...
template <typename T>
using operator_minus = std::enable_if_t<!std::is_unsigned_v<T>,
...
template <typename T>
using operator_bnot = std::enable_if_t<!std::is_same_v<T, bool>,
                                       decltype(~std::declval<const T&>())>;
template <typename T, typename U = const T&>
...
template <typename T>
using operator_pre_inc =
    std::enable_if_t<!std::is_same_v<T, bool>, decltype(++std::declval<T&>())>;
template <typename T>
using operator_post_inc =
    std::enable_if_t<!std::is_same_v<T, bool>, decltype(std::declval<T&>()++)>;
template <typename T>
using operator_pre_dec =
    std::enable_if_t<!std::is_same_v<T, bool>, decltype(--std::declval<T&>())>;
template <typename T>
using operator_post_dec =
    std::enable_if_t<!std::is_same_v<T, bool>, decltype(std::declval<T&>()--)>;

template <typename T>
using operator_assign_copy =
    std::enable_if_t<std::is_copy_assignable_v<T>,
                     decltype(std::declval<T&>() = std::declval<const T&>())>;
template <typename T>
using operator_assign_move =
    std::enable_if_t<std::is_move_assignable_v<T>,
                     decltype(std::declval<T&>() = std::declval<T&&>())>;
template <typename T, typename U = const T&>
using operator_assign_add =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() += std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_sub =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() -= std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_mul =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() *= std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_div =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() /= std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_mod =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() %= std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_band =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() &= std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_bor =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() |= std::declval<U>())>;
template <typename T, typename U = const T&>
using operator_assign_bxor =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() ^= std::declval<U>())>;
template <typename T, typename U = std::size_t>
using operator_assign_lshift =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() <<= std::declval<U>())>;
template <typename T, typename U = std::size_t>
using operator_assign_rshift =
    std::enable_if_t<!std::is_same_v<T, bool>,
                     decltype(std::declval<T&>() >>= std::declval<U>())>;
...
template <typename T, typename U = std::size_t>
using operator_subscript_const =
    decltype(std::declval<const T&>()[std::declval<U>()]);
template <typename T>
...
template <typename T, typename U>
using operator_member_of_pointer =
...
using container_assign =
    decltype(std::declval<T&>().assign(std::declval<U>(), std::declval<V>()));
...
template <typename T, typename U = typename T::size_type>
using container_subscript_const =
    decltype(std::declval<const T&>()[std::declval<U>()]);
...
using container_resize_0 =
    decltype(std::declval<T&>().resize(std::declval<U>()));

template <typename T, typename U = typename T::size_type,
          typename V = const typename T::value_type&>
using container_resize_1 =
    decltype(std::declval<T&>().resize(std::declval<U>(), std::declval<V>()));
...
using container_insert_or_assign_0 =
    decltype(std::declval<T&>().insert(std::declval<U>(), std::declval<V>()));
template <typename T, typename U = const typename T::key_type&,
          typename V = const typename T::mapped_type&&>
using container_insert_or_assign_1 =
    decltype(std::declval<T&>().insert(std::declval<U>(), std::declval<V>()));
template <typename T, typename U = typename T::key_type&&,
          typename V = const typename T::mapped_type&>
using container_insert_or_assign_2 =
    decltype(std::declval<T&>().insert(std::declval<U>(), std::declval<V>()));
template <typename T, typename U = typename T::key_type&&,
          typename V = const typename T::mapped_type&&>
using container_insert_or_assign_3 =
    decltype(std::declval<T&>().insert(std::declval<U>(), std::declval<V>()));
template <typename T, typename U = typename T::const_iterator,
          typename V = const typename T::key_type&,
          typename W = const typename T::mapped_type&>
using container_insert_or_assign_4 = decltype(std::declval<T&>().insert(
    std::declval<U>(), std::declval<V>(), std::declval<W>()));
template <typename T, typename U = typename T::const_iterator,
          typename V = const typename T::key_type&,
          typename W = const typename T::mapped_type&&>
using container_insert_or_assign_5 = decltype(std::declval<T&>().insert(
    std::declval<U>(), std::declval<V>(), std::declval<W>()));
template <typename T, typename U = typename T::const_iterator,
          typename V = typename T::key_type&&,
          typename W = const typename T::mapped_type&>
using container_insert_or_assign_6 = decltype(std::declval<T&>().insert(
    std::declval<U>(), std::declval<V>(), std::declval<W>()));
template <typename T, typename U = typename T::const_iterator,
          typename V = typename T::key_type&&,
          typename W = const typename T::mapped_type&&>
using container_insert_or_assign_7 = decltype(std::declval<T&>().insert(
    std::declval<U>(), std::declval<V>(), std::declval<W>()));
...
using container_push_front_0 =
    decltype(std::declval<T&>().push_front(std::declval<U>()));
template <typename T, typename U = typename T::value_type&&>
using container_push_front_1 =
    decltype(std::declval<T&>().push_front(std::declval<U>()));
...
template <typename T, typename U = const typename T::value_type&>
using container_push_back_0 =
    decltype(std::declval<T&>().push_back(std::declval<U>()));
template <typename T, typename U = typename T::value_type&&>
using container_push_back_1 =
    decltype(std::declval<T&>().push_back(std::declval<U>()));
...
template <typename T, typename U = typename T::const_iterator>
using container_extract_0 =
    decltype(std::declval<T&>().extract(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_extract_1 =
    decltype(std::declval<T&>().extract(std::declval<U>()));

// - lookup

template <typename T, typename U = const typename T::key_type&>
using container_count =
    decltype(std::declval<const T&>().count(std::declval<U>()));

template <typename T, typename U = const typename T::key_type&>
using container_find = decltype(std::declval<T&>().count(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_find_const =
    decltype(std::declval<const T&>().count(std::declval<U>()));
// contains (C++20)
template <typename T, typename U = const typename T::key_type&>
using container_lower_bound =
    decltype(std::declval<T&>().lower_bound(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_lower_bound_const =
    decltype(std::declval<const T&>().lower_bound(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_upper_bound =
    decltype(std::declval<T&>().lower_bound(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_upper_bound_const =
    decltype(std::declval<const T&>().lower_bound(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_equal_range =
    decltype(std::declval<T&>().equal_range(std::declval<U>()));
template <typename T, typename U = const typename T::key_type&>
using container_equal_range_const =
    decltype(std::declval<const T&>().equal_range(std::declval<U>()));
