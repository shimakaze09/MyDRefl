...
struct TypeInfo {
  ...
  // without bases, static
  InvokeResult Invoke(StrID methodID, void* result_buffer,
                      Span<TypeID> argTypeIDs, void* args_buffer) const;
  // without bases, const + static
  InvokeResult Invoke(const void* obj, StrID methodID, void* result_buffer,
                      Span<TypeID> argTypeIDs, void* args_buffer) const;
  // without bases, non-const + const + static, non-const && static > const
  InvokeResult Invoke(void* obj, StrID methodID, void* result_buffer,
                      Span<TypeID> argTypeIDs, void* args_buffer) const;
};
}  // namespace My::MyDRefl
